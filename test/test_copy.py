...
# 请给以下变量赋值：
age = 20  # 赋值为 20
height = 1.75  # 赋值为 1.75
name = "张三"  # 赋值为 "张三"
is_student = True  # 赋值为 True

# 练习2：类型转换
# 请完成以下类型转换：
age_from_str = int("25")  # 将字符串 "25" 转换为整数
str_from_int = str(100)  # 将整数 100 转换为字符串
int_from_float = int(3.14)  # 将浮点数 3.14 转换为整数
...
correct_answer = {
    ...
    "types": {"age_type": "<class 'int'>", "height_type": "<class 'float'>", "name_type": "<class 'str'>",
              "is_student_type": "<class 'bool'>"}
}
...
student_answer = {
    ...
    "types": {"age_type": str(age_type), "height_type": str(height_type), "name_type": str(name_type),
              "is_student_type": str(is_student_type)}
}
